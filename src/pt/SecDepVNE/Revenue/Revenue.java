...
public class Revenue {
	...
	public static void readDvineRevenue() throws IOException {
		...
		FileWriter fileWriter = new FileWriter("../revenues/dvine.txt");
		BufferedWriter writer = new BufferedWriter(fileWriter);

		for(int i = 0; i < 1000; i++){

			if(wasAccepted("../glpk/outputFiles/DViNE/random_exp1/random_req"+i+".txt")) {

				FileReader fileReader = new FileReader("../glpk/datFiles/DViNE/random_exp1/random_req"+i+".dat");
	...
	public static void readSecDepRevenue() throws IOException {
		...
		FileWriter fileWriter = new FileWriter("../revenues/mixsecdep_5.txt");
		BufferedWriter writer = new BufferedWriter(fileWriter);

		for(int i = 0; i < 1000; i++){

			if(wasAccepted("../glpk/outputFiles/SecDep/random_exp7/random_req"+i+".txt")) {

				FileReader fileReader = new FileReader("../glpk/datFiles/SecDep/random_exp7/random_req"+i+".dat");
				BufferedReader reader = new BufferedReader(fileReader);
